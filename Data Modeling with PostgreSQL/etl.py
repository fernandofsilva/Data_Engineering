...
def process_song_file(cur, filepath):
    ...
    Process the song files and insert the data into songs and artist table

    :param cur: cursor fron the postgresql database
    :param filepath: path with the files
...
def process_log_file(cur, filepath):
    ...
    Process the log files and insert the data into time, user and songplays
    table
...
def process_data(cur, conn, filepath, func):
    ...
    :param cur: cursor fron the postgresql database
    :param conn: connection from the postgres database
    :param filepath: path with the files
